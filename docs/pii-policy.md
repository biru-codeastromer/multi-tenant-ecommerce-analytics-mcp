...
1. **Ingest-time rejection or hashing**, which is the real fix. Catching PII at write time means it
...
2. **An allowlist rather than a denylist**, where orgs declare which property keys are
